...
{% highlight scss %}@include border-radius(4px, 4px);{% endhighlight %}
...
{% highlight coffeescript %}song = ["do", "re", "mi", "fa", "so"]
...
{% highlight javascript %}var bitlist, kids, singers, song;
song = ["do", "re", "mi", "fa", "so"];
singers = {
  Jagger: "Rock",
  Elvis: "Roll"
